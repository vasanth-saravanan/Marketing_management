...
//services
import * as Action from '../../redux/Expected_Payable/Action'

//root store
import { RootStore } from '../../redux/store'


export function ExpectedPayable({ navigation } : any) {
    ...
    const getNetInfo = (CompanyUrl : any, BusinessUnitId : any, pageno : number , SetState : any) => {
      ...
      NetInfo.fetch().then((status) => {
          if(status.isConnected == true){
            dispatch(Action.getExpPayable(CompanyUrl, BusinessUnitId, pageno, SetState))
          }else {
    ...
    useEffect(() => {
        dispatch(Action.getExpPayable(CompanyUrl, BusinessUnitId, 0, SetState))
    }, [])
        ...
        <View style={styles.backgroundContainer}>
            <View style={styles.header}>
                <View style={styles.headerRight}>
                    ...
                    <Text style={styles.salesDetails}>{constants.Labels.exp_payable}</Text>
                </View>
            </View>
            <SegmentedControl
            ...
            <View style={styles.totalAmountBoxContainer}>
                    <View style={{...styles.totalAmountBox , backgroundColor :'#fd1c23'}}>
